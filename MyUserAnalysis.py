...
ndata     =  12. 	# Number of events observed in data
nbkg      =  13.5	 	# Number of predicted bkg events
nsig      =  1000.  	# Number of predicted signal events
nbkgErr   =  0.05 #1.  	# (Absolute) Statistical error on bkg estimate
nsigErr   =  0.001 #2.  	# (Absolute) Statistical error on signal estimate
lumiError = 0.0001 #0.039 	# Relative luminosity uncertainty
